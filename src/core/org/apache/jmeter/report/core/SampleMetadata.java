...
public class SampleMetadata {
    ...
    private static final String METADATA_EXCEPTION_MSG_FMT =
            "No column <%s> found in sample metadata <%s>, check #jmeter.save.saveservice.* properties to add the missing column";
