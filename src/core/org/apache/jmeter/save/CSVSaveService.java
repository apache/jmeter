...
public final class CSVSaveService {
     ...
     * 
     * <p>
     * If the value contains a special character, then the String value is
     * returned enclosed in the quote character.
     * </p>
     * 
     * <p>
     ...
     * 
     * <p>
     * If the value does not contain any special characters, then the String
     ...
     * 
     * @param specialChars
     *            special characters; second one must be the quote character
     * 
     * @return the input String, enclosed in quote characters if the value
     *         contains a special character, <code>null</code> for null string
     *         input
     */
