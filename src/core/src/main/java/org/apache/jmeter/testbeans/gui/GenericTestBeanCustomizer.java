...
public class GenericTestBeanCustomizer extends JPanel implements SharedCustomizer {
    ...
    @API(status = API.Status.INTERNAL, since = "6.0.0")
    public static <T extends Enum<?> & ResourceKeyed> @Nullable T normalizeEnumStringValue(String value, Class<?> klass, Class<T> enumKlass) {
    ...
    private static <T extends Enum<?> & ResourceKeyed> @Nullable T normalizeEnumStringValue(String value, Class<?> klass, List<T> values) {
