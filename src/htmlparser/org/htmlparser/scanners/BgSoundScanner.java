...
/**
 * Scans for the bgsound Tag. This is a subclass of TagScanner, and is called using a 
 * variant of the template method. If the evaluate() method returns true, that means the
 * given string contains an bgsound tag. Extraction is done by the scan method thereafter
...
public class BgSoundScanner extends TagScanner
{
    ...
    /**
     * Extract the location of the bgsound, given the string to be parsed, and the url
