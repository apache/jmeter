        ...
        if (!StringUtils.isEmpty(format)) {
            try {
                ...
                log.error("Format date pattern '{}' is invalid " +
                        "(see https://docs.oracle.com/javase/8/docs/api/java" +
                        "/time/format/DateTimeFormatter.html)", format, ex);
                return "";
            }
        }
        ...
        if (!StringUtils.isEmpty(amountToShift)) {
            try {
                ...
                log.error("Failed to parse the amount duration '{}' to shift " +
                        "(see https://docs.oracle.com/javase/8/docs/api/java" +
                        "/time/Duration.html#parse-java.lang.CharSequence-) ", amountToShift, ex);
            }
        }
        String dateString;
        if (formatter != null) {
