...
public class XPath2ExtractorCorrelationRule extends CorrelationRule {
    ...
    public XPath2ExtractorCorrelationRule(XPath2Extractor xPath2Extractor) {
        super(xPath2Extractor);
    ...
    public boolean equals(Object rule) {
        ...
        XPath2ExtractorCorrelationRule correlationRule = (XPath2ExtractorCorrelationRule) rule;
