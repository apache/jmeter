...
public class XPath2ExtractorData extends ExtractorData {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof XPath2ExtractorData)) {
            return false;
        }
        XPath2ExtractorData xPathExData = (XPath2ExtractorData) o;
        return xPathExData.getxPathQuery().equals(xPathQuery);
    }

    @Override
    public int hashCode() {
        int result = 17;
        result = 31 * result + xPathQuery.hashCode();
        return result;
    }
