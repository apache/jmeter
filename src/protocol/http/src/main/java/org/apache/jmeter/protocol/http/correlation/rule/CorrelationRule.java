...
public class CorrelationRule {
    ...
    public CorrelationRule(Object jsonData) throws JsonMappingException, JsonProcessingException {
        HashMap<String, String> data = new ObjectMapper().readValue(jsonData.toString(), new TypeReference<HashMap<String,String>>() {});
        setName(data.get("name"));
        setType(data.get("type"));
        setExpr(data.get("expr"));
        setAttribute(data.get("attribute"));
        setlBoundary(data.get("lBoundary"));
        setrBoundary(data.get("rBoundary"));
    }
