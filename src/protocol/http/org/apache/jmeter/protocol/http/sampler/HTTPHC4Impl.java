                ...
                protected HttpRequestRetryHandler createHttpRequestRetryHandler() {
                    return new DefaultHttpRequestRetryHandler(RETRY_COUNT, false) {
                        ...
                        public boolean retryRequest(IOException ex, int count, HttpContext ctx) {
                             ...
                             * So we check for the specific exception that is triggered.
                             */
                            if (ex instanceof java.net.BindException) {
                                /*
                                 * This message is generated by aborted connects.
                                 * If it occurs in other situations, retrying is unlikely to help,
