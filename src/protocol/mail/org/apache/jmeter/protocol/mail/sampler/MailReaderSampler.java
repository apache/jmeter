	...
	extends AbstractSampler 
{
   private static Logger log = LoggingManager.getLoggerForClass();
	...
	/**
	 * Sets the type of protocol to use when talking with the
	 * remote mail server. Either MailReaderSampler.TYPE_IMAP
	 * or MailReaderSampler.TYPE_POP3. Default is 
	...
	/**
	 * Returns the type of the protocol set to use when talking
	 * with the remote server. Either MailReaderSampler.TYPE_IMAP
	 * or MailReaderSampler.TYPE_POP3.
	 * 
	 * @return Server Type
	 */
	...
	/**
	 * @param server - The name or address of the remote server.
	 */	
	...
	/**
	 * @param username - The username of the mail account.
	 */
	...
	/**
	 * @param folder - Name of the folder to read emails from.
	 * "INBOX" is the only acceptable value if the server type is
	 * POP3.
	 */
	 ...
	 * from the mail server. Set this value to -1 to retrieve 
	 * all messages.
	 */
	...
	/**
	 * @return The number of messages to retrive from the mail
	 * server. -1 denotes get all messages.
	 */
	...
	/**
	 * @param delete - Whether or not to delete the read messages
	 * from the folder.
	 */	
	...
	/**
	 * @return Whether or not to delete the read messages from
	 * the folder.
	 */
