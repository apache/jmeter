 ...
 * @author pete
 *
 * BaseJMSSampler is an abstract class which provides implementation for
 * common properties. Rather than duplicate the code, it's contained in the
 * base class.
 */
public abstract class BaseJMSSampler
	...
	/**
	 * method returns the initial context factory for jndi 
	...
	/**
	 * return the connection factory parameter used to
	 * lookup the connection factory from the JMS server
	 * @return
	 */	
	...
	/**
	 * set the username to login into the jms server
	 * if needed
	 * @param user
	 */	
	...
	/**
	 * return the username used to login to the jms
	 * server
	 * @return
	 */	
	...
	/**
	 * return the password used to login to the jms 
	 * server
	 * @return
	 */	
	...
	/**
	 * set whether the sampler should read the response
	 * or not
	 * @param read
	 */
