...
public class TestHTTPArgument {
        ...
        public void testWithFix() throws Exception {
            String filename = getResourceFile("shift_jis.properties");
        ...
        private void testEncodings(String encoding) {
            ...
            // When the name and value parameter does not have valid encoded value (Encoded and Decoded values are same)
            // In real encoded value for "name.?" is "name.%3F" and the encoded value for "value_here" is "value_+here"
        ...
        private String getResourceFile(String resource) {
